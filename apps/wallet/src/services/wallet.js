...
console.log('ddddddddddddddddddddddddddddddddddd', ethers);
...
export default class Wallet {
  ...
  setupWallet = async (message) => {
    ...
    window.walletAPI.saveWalletData(this.data);
...
console.log(1234567890);
      ...
      console.log('setupEthers function err:', err);
    }
  }
