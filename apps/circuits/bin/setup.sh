...
npx snarkjs powersoftau new bn128 12 ./circom/ptau/pot12_0000.ptau -v
...
npx snarkjs powersoftau contribute ./circom/ptau/pot12_0000.ptau ./circom/ptau/pot12_0001.ptau \
    --name="First contribution" -v -e="$(head -n 4096 /dev/urandom | openssl sha1)"
npx snarkjs powersoftau contribute ./circom/ptau/pot12_0001.ptau ./circom/ptau/pot12_0002.ptau \
    --name="Second contribution" -v -e="$(head -n 4096 /dev/urandom | openssl sha1)"
npx snarkjs powersoftau contribute ./circom/ptau/pot12_0002.ptau ./circom/ptau/pot12_0003.ptau \
    --name="Third contribution" -v -e="$(head -n 4096 /dev/urandom | openssl sha1)"

# Verify
npx snarkjs powersoftau verify ./circom/ptau/pot12_0003.ptau
...
npx snarkjs powersoftau beacon ./circom/ptau/pot12_0003.ptau ./circom/ptau/pot12_beacon.ptau \
...
npx snarkjs powersoftau prepare phase2 ./circom/ptau/pot12_beacon.ptau ./circom/ptau/pot12_final.ptau -v

# Verify the final ptau file. Creates the file pot12_final.ptau
npx snarkjs powersoftau verify ./circom/ptau/pot12_final.ptau
